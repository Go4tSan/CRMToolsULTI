...
$resultado->execute(); 
$data=$resultado->fetchAll(PDO::FETCH_ASSOC);   lineas inecesarias para el login*/ 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user"  action="../crud/bd/login.php" method="post" >
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="usario" name="usuario" aria-describedby="emailHelp"
