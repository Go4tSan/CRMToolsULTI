...
<head>
  ...
  <link href="Assets/Estilos/bootstrap/css/sb-admin-2.min.css" rel="stylesheet">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="Principal">
        ...
        <img src="Assets/img/crm.png" alt="CRMTools" width="50" height="50">
        </div>
